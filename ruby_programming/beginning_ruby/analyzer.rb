...
# count them, and work out the percentage of non_wrds words
# against all words
...
one_third = sentences = sentences_sorted.length / 3
...
puts "#{good_percentage}% of words are none-fluff words"
